...
c
C radial-width loop LINKS is in BEGRI
      CALL BEGRI
C
C     ENDE LOOP RADIALWEITEN RECHTS
   76 CONTINUE
c
C the 480,1 loops mark non-zero entries in an index array IND(.,.)
C in the 910/920 loops only those me's are written on tape with IND=1   
   80 DO 480 M=1,MKANZ
C     LOOP BASISVEKTOREN LINKS
C
      MM=M-1+MKANA
