...
C
      ...
      MEFI=23
C      WRITE(NOUT,1111)
1111  FORMAT(' KOBER_STREU VOM 18.2.1999')
      DO 329 I=1,NDIM1
329   SNSP(I)= 0.
...
C      write(nout,*) IKM,(JHUX(KKX),SNSP(KKX),KKX=1,IKM)
       JA=1
       DO 168 I=1,IKM
       DO 166 J=JA,JPTOT
...
C     AUFSUCHEN DER PERMUTATION P0
  ...
  100 DO 101 K=1,NZT
      NKOR(K,1)=K
  101 NKOR(K,3)=K
c     write(nout,*) 'kt,lt',kt,lt,'nkor2',(nkor(iws,2),iws=1,nzt)
      I=1
      DO 104 K=1,NZT
...
c     write(nout,*) 'kt2,lt2',kt2,lt2,'nkor7',(nkor(iws,7),iws=1,nzt)
c     write(nout,*) 'mlkc,nkc,kk,ift,np(5)',
c    *              mlkc,nkc,kk,ift,np(5),' j=',j,snsp(j)
  120 CONTINUE
26     KT=KT+1
