      PARAMETER (NZOPER=17, NZOPOB=15, NZOPLU=8, NZTMAX=4,
     *           NZFMAX=100, NZCMAX=6, MZGMAX=14, NZLWMA=20,
     *           NZRHOM=100, NZPARM=100, MZPARM=30, NZPOMA=3,
     *           NZIQMA=9, NZPOTM=84,  NDIM=840,
     *           NDIM1=48000, NDIM5=9000, NPDC=8040)
