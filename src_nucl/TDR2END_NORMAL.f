...
C
 ...
 193  NCOF(L,N) = 1
   ...
   27 CONTINUE
      ...
      UMK(J) = UMKOF(N,M)
  25  CONTINUE
C      WRITE (NOUT,1018) N, (UMK(M),NUMK(M),M=1,J)
      N2 = 3
      I=0
      DO 84 J=1,NZBASV
...
751   CONTINUE
      ...
      MATOUN=29
      OPEN(UNIT=29,FILE='MATOUTN',STATUS='UNKNOWN',FORM='FORMATTED')
      WRITE(MATOUN,'(I8)') MMM
      WRITE(MATOUN,'(E20.14)')
...
c      CLOSE(UNIT=19,STATUS='KEEP')
     ...
     * ((H(N,M),N=1,MMM),M=1,MMM)
      ...
      if(ICOPMA.eq.1) then 
      STOP 'TDR2END_NORMAL.f:   NORM, HAMILTONIAN MATRICES WRITTEN.'
      endif
