...
cC     OBERPROGRAMM FUER EINTEILCHENOPERATOREN MIT EINTEILCHEN PUNKTIERTE
...
C
      COMMON ANSP(NDIM1),NGRU(2,NZCMAX,2),
     *       NOUT,NZT,NZV,I1,I2,I3,MGW(NZCMAX+1), 
     *       MMOEG(NDIM3),MSR(NZCMAX,NZCMAX),MVV(35,NZCMAX),NBAND2
C
     ...
     *         NCOF2(MZGMAX,NZGMAX,NZFMAX),IMV(NZMAT)
C
...
C      DC NACHEINANDER ERFOLGEN
      ANSP(J)=ANSP(J)+FLOAT(NP(5))*FAK*FLOAT(IFT)
