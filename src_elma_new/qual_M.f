...
54    WR(M)=RVEC(M,NT1)
      ...
      WRITE(NOUT,*) 'J(A-1,I)=',(WR(NN),NN=1,NZV)
...
C
  ...
  150 D(M) = .0
      ...
      FF=FF**3
C
      IF(NBAUS.GT.3) WRITE(6,*) 'BETA',(BETA(K),K=1,NZV),' FF ',
     *   FF
C     
      DO 91   M = 1,NZAV
...
c      EQUIVALENCE (WERT(1,1,1),WERTT(1,1))
...
24    DO 80, N=NL,NU
       ...
       VORFAK=H(N)
       IF (MKC.EQ.1) VORFAK=H(N)*2./ DBLE(NZT*NZV)
