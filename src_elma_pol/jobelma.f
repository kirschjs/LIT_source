...
C     AUSDRUCK DER FUNKTIONSEIGENSCHAFTEN                               
 ...
 1016 FORMAT(/30H ZERLEGUNG IN DIE GRUPPEN VON   ,I2,4H UND,I2,         
     ...
     3   15H GESAMTSPIN IST   ,I2,3H /2    /)                           
      WRITE (NOUT,1090)                                                 
      WRITE (NOUT,2011)                                                 
      IF(NREG(1).NE.0) WRITE(NOUT,611)
      IF(NREG(2).NE.0) WRITE(NOUT,612)
      IF(NREG(3).NE.0) WRITE(NOUT,613)
      IF(NREG(4).NE.0) WRITE(NOUT,614)
      IF(NREG(5).NE.0) WRITE(NOUT,615)
