...
2011  FORMAT(////18H BERECHNET WERDEN )                                 
      WRITE (NOUT,2011)                                                 
      IF(LREG(1).GT.0) WRITE(NOUT,610)
      IF(LREG(2).GT.0) WRITE(NOUT,611) MUL
      IF(LREG(3).GT.0) WRITE(NOUT,612) MUL
      IF(LREG(4).GT.0) WRITE(NOUT,613) MUL
      IF(LREG(5).GT.0) WRITE(NOUT,614) MUL
      IF(LREG(6).GT.0) WRITE(NOUT,615) MUL
      IF(LREG(7).GT.0) WRITE(NOUT,616) MUL
      IF(LREG(8).GT.0) WRITE(NOUT,617) MUL
      IF(LREG(9).GT.0) WRITE(NOUT,618) MUL
      IF(LREG(10).GT.0) WRITE(NOUT,619) MUL
      IF(LREG(11).GT.0) WRITE(NOUT,620) MUL
610   FORMAT(//'NORM-OPERATOR')
...
202   CONTINUE
      ...
      GO TO (4000,4001,4002,4003,4004,4005,4006,4007,4008,4009,4010)
     *       ,MKC
4000  WRITE(NOUT,610)
      GO TO 3008
