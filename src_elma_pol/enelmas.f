...
C     1   '-PROTON-BAHN-OPERATOR'
C     2   '-NEUTRON-BAHN-OPERATOR'
C     3   '-PROTON-SPIN-OPERATOR'
C     4   '-NEUTRON-SPIN-OPERATOR'
C     5   '-PROTON-BAHN-OPERATOR'
C     6   '-NEUTRON-BAHN-OPERATOR'
C     7   '-PROTON-SPIN-OPERATOR'
C     8   '-NEUTRON-SPIN-OPERATOR'
C     9   '-R**L*YL-PROTON-OPERATOR'
C    10   '-R**L*YL-NEUTRON-OPERATOR'
C
      COMMON/COMY/D(100)
C
...
C
     ...
     *    LUM(NZPARM+1,NZKMAX),  DN(NZPARM,NZPARM), NZREL(NZFMAX),
...
C
      ...
      IF (MREG(9).EQ.0.OR.MREG(10).EQ.0) then
...
C     ENDE LOOP ZERLEGUNGEN LINKS
  140 CONTINUE
      ...
      WRITE(NBAND2)
     *   (( (DM(K,L,10)+DM(K,L,9))
c     * (( (DM(K,L,10)+DM(K,L,9))/SQRT(DM(L,L,1)*DM(K,K,1))
